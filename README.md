...
2. Choose any option like 
    - add a new expense or
    - view all expenses or
    - get the total spent expenses 
3. If adding an expense(Enter name of category, and amount). 
4. Save the expense to the list
...
# TECHNOLOGY USED :-
1. Python (Programming lanuguage used )
2. Git AND GitHub (Version Control)
3. VS Code (Code Editor)


# MADE BY :-
Sambit Kumar Garanayak
